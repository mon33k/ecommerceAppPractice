...
INSERT INTO users (users_id, username, fullname, email, user_address) values (1, 'usertest', 'user test', 'test@test.com', '10 Test Plaza');
INSERT INTO users (users_id, username, fullname, email, user_address) values (2, 'dhembry1', 'Duffy Hembry', 'dhembry1@so-net.ne.jp', '92 Sage Crossing');
INSERT INTO users (users_id, username, fullname, email, user_address) values (3, 'ashearn2', 'Anthia Shearn', 'ashearn2@t-online.de', '390 Independence Drive');
INSERT INTO users (users_id, username, fullname, email, user_address) values (4, 'gwhild3', 'Gunter Whild', 'gwhild3@newsvine.com', '444 Sugar Trail');
INSERT INTO users (users_id, username, fullname, email, user_address) values (5, 'ffarens4', 'Fernande Farens', 'ffarens4@meetup.com', '6163 Carpenter Junction');
